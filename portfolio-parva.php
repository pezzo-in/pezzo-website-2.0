        ...
        <div class="portfolio-single">
            ...
            <div class="row">
                ...
                <div class="col-md-4 portfolio-field portfolio-nav">
                    <a class="icon button prev ajax" href="portfolio-neeladhri-ceramics.php"></a>
                    <a class="icon button next ajax" href="portfolio-castle-key.php"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-8 portfolio-field">
                    <img src="images/portfolio/parva/desktop.jpg" alt="project">
                    <img src="images/portfolio/parva/tablet.jpg" alt="project">
                </div>
                <!-- PORTFOLIO-IMAGES - column 8/12 -->
                ...
                <div class="col-md-4 portfolio-field">
                    ...
                    <p> PARVA are here to conceptualize, plan, improvise and execute your events so that you can just
                        sit back and enjoy whether you are planning for a massive event or a small intimate wedding
                        party.</p>

                    <p>Weddings portray the union of not only two souls but also two families. At ‘PARVA’ we would like
                        to be the mirror that reflects your joy and happiness through specializing in wedding planning
                        and taking personal care , time , effort to ensure that the smallest of things go right on your
                        big day right from welcoming the groom till bidding goodbye to the bride because we believe that
                        ‘small things become great when done with love.’</p>
                    ...
                    <div class="launch">
                        <a href="http://parva.co.in" class="button primary" target="_blank">LAUNCH PROJECT</a>
                    </div>
                </div>
                <!-- PORTFOLIO SIDEBAR - column 4/12 -->
            </div>
