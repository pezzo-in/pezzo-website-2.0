    ...
    <div class="col-md-8">
        ...
        <div class="intro">
            <h2>
                ...
                Backed by industry experts and geniuses with passion towards excellence.
            </h2>
        </div>
        <!-- intro -->
    </div>
...
<h2 class="section-title"><span><i class="icon-doc-alt"></i>MARKETING CONSULTATION</span></h2>

<p>You can download my CV in pdf format if you like. I currently work for PEZZO creative studio. I
    create usable web interfaces, front end coding stuff and almost. But i love what i do.</p>
...
<h2 class="section-title"><span><i class="icon-doc-alt"></i>GRAPHIC DESIGN</span></h2>

<p>You can download my CV in pdf format if you like. I currently work for PEZZO creative studio. I
    create usable web interfaces, front end coding stuff and almost. But i love what i do.</p>

<h2 class="section-title"><span><i class="icon-doc-alt"></i>BRANDING</span></h2>

<p>You can download my CV in pdf format if you like. I currently work for PEZZO creative studio. I
    create usable web interfaces, front end coding stuff and almost. But i love what i do.</p>
</div>-->
<div class="col-md-6">
    <div class="timeline"><h2><i class="fa fa-bullhorn"></i>MARKETING CONSULTATION</h2>
        ...
        <div class="event">
            ...
            <p>We build strong brands that make good impressions in the hearts and minds. Whether it's a revamp of an
                ...
                program. Our goal is to help our clients stand out from the competition.</p>
        </div>
        <div class="event">
            <span class="date">&amp;</span>
        ...
        <div class="event">
            ...
            <p>Writings are the way to touch users' thoughts. This is the voice of a company to its users. Great
                ...
                they will enjoy in future.</p>
        </div>
    </div>
    <div class="timeline"><h2><i class="fa fa-html5"></i>WEB DEVELOPMENT</h2>
...
<div class="col-md-6">
    <div class="timeline"><h2><i class="fa fa-pencil"></i>DESIGN</h2>
        ...
        <div class="event current">
            ...
            <p>The art of capturing/creating a composition with aesthetics is motion design. With expertise in 3D/2D
                ...
                you won't feel like looking away from the screen even for a second.</p>
        </div>
        <div class="event">
            <span class="date">&amp;</span>
    ...
    <div class="timeline"><h2><i class="icon-camera-2"></i>PHOTOGRAPHY &amp; CINEMATOGRAPHY</h2>
        ...
        <div class="event">
            ...
            <p>A picture speaks a thousand words. What better than a photograph to explain those precious moments with
                ...
                cherish for years to come. We also provide fine art and product photography services.</p>
        </div>
        <div class="event">
            <span class="date">&amp;</span>
            <h5>Editing</h5>
...
<!--<div class="col-md-12">
    ...
    <div class="testo col-md-5">
        <img src="images/site/testo-01.jpg" alt="someone">
        <h4>Phillip Austin <span>CEO / Gravity Inc.</span></h4>

        <p>He is a great and hardworking guy. we are so proud of i have him as my asistant. He helped me
            so much.
            Also he is a great and hardworking guy. we are so proud of i have him as my asistant. He
            helped me so
            much.</p>
    </div>
    ...
    <div class="testo col-md-5">
        ...
        <p>He was a great co-worker and a friend. I would't be where we are without his support.</p>
    </div>
    <div class="col-md-1"></div>
    <div class="testo col-md-5">
...
<section id="contact" class="page">
    <div class="content">
        ...
        <div class="row">
            <!-- column 6/12 -->
            <div class="col-md-6"><h2 class="section-title"><span><i
                    class="icon-address-book"></i>LET'S GET IN TOUCH</span></h2>
                <!-- LETTER -->
                <div class="letter"><!-- <h4 class="letter-title">PEZZO</h4> -->

                    <div class="stamp">
                        <img src="images/site/badge.png" alt="stamp">
                    </div>
                    <div class="letter-info">
                        <p><i class="icon-at"></i>info@pezzo.in</p>
            ...
            <div class="col-md-6">
                ...
                <!-- GOOGLE MAP -->
                <div class="map">
                    <div data-latitude="12.915633" data-longitude="77.546665" data-zoom="12" id="map-canvas"
